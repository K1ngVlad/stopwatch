...
const millisecondsNum = document
  .querySelector('#milliseconds')
  .querySelector('.num');
...
const changeTime = () => {
  ...
  switch (millisecondsString.length) {
    case 1:
      millisecondsNum.textContent = `0 0 ${millisecondsString}`;
      break;
    case 2:
      millisecondsNum.textContent = `0 ${millisecondsString[0]} ${millisecondsString[1]}`;
      break;
    case 3:
      millisecondsNum.textContent = `${millisecondsString[0]} ${millisecondsString[1]} ${millisecondsString[2]}`;
      break;
    default:
      break;
  }
  ...
  secondsNum.textContent =
    secondsString.length === 2
      ? `${secondsString[0]} ${secondsString[1]}`
      : `0 ${secondsString[0]}`;
  minutesNum.textContent =
    minutesString.length === 2
      ? `${minutesString[0]} ${minutesString[1]}`
      : `0 ${minutesString[0]}`;
